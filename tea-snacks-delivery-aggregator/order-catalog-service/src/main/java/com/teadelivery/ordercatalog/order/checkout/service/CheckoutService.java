...
public class CheckoutService {
         ...
         */
        @Transactional
        public OrderDetailsResponse commitCheckout(CommitCheckoutRequest request) {
                ...
                if (session.getStatus() != CheckoutSessionStatus.READY_FOR_COMMIT) {
         ...
         */
        private OrderDetailsResponse buildCommitResponse(Order order, CheckoutSession session,
                        VendorBranch vendorBranch) {
                // Convert order items to checkout items for consistent response
                List<OrderDetailsResponse.CheckoutItem> items = order.getOrderItems().stream()
                                .map(item -> OrderDetailsResponse.CheckoutItem.builder()
                ...
                int totalItems = items.stream().mapToInt(OrderDetailsResponse.CheckoutItem::getQuantity).sum();
                int prepTime = 25;
                int deliveryDuration = 20;
                int totalTime = prepTime + deliveryDuration;
                ...
                return OrderDetailsResponse.builder()
                                ...
                                .statusDisplayName(CheckoutSessionStatus.COMMITTED.getDisplayName())
                                ...
                                // Vendor
                                .vendor(OrderDetailsResponse.VendorInfo.builder()
                                ...
                                // Pricing
                                .pricing(OrderDetailsResponse.PricingDetails.builder()
                                                ...
                                                .build())
                                // Delivery info
                                .delivery(OrderDetailsResponse.DeliveryInfo.builder()
                                                ...
                                                .build())
                                // Payment info
                                .payment(OrderDetailsResponse.PaymentInfo.builder()
                                                .status(order.getPaymentStatus().name())
                                                .statusDisplayName(orderService
                                                                .getPaymentStatusDisplayName(order.getPaymentStatus()))
                                                .method(order.getPaymentMethod())
                                                .methodDisplayName(orderService
                                                                .getPaymentMethodDisplayName(order.getPaymentMethod()))
        ...
        private CreateOrderRequest convertSessionToOrderRequest(
                ...
                List<OrderItemRequest> orderItems = session.getItems().stream()
                                .map(cartItem -> {
                                        ...
                                        if (menuItem.getImages() != null
                                                        && menuItem.getImages().get("thumbnail") != null) {
                ...
                CreateOrderRequest.DeliveryAddressRequest addressRequest = CreateOrderRequest.DeliveryAddressRequest
                                .builder()
